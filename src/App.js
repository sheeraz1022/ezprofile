                    ...
                    error ? (
                        ...
                        <Fragment>
                            ...
                            <footer className="p-4 footer bg-base-200 text-base-content footer-center">
                                <div>
                                    <p className="font-mono text-sm">Made with <a className="text-primary" href="https://github.com/sheeraz1022/ezprofile" target="_blank" rel="noreferrer">ezProfile</a></p>
                                </div>
                            </footer>
                        </Fragment>
                    )
